...
class MarketplaceConfigurationCurrencyEnum(str):
    ...
    AZN = 'AZN'
    BOSNIA_HERZEGOVINA_CONVERTIBLE_MARK = 'Bosnia-Herzegovina Convertible Mark'
    BAM = 'BAM'
    ...
    BYN = 'BYN'
    BELARUSIAN_RUBLE_PRE_2016 = 'Belarusian Ruble (pre-2016)'
    BYR = 'BYR'
    ...
    CHF = 'CHF'
    CHILEAN_UNIT_OF_ACCOUNT_UF = 'Chilean Unit of Account (UF)'
    CLF = 'CLF'
    CHILEAN_PESO = 'Chilean Peso'
    CLP = 'CLP'
    CHINESE_YUAN_OFFSHORE = 'Chinese Yuan (Offshore)'
    CNH = 'CNH'
    ...
    MOP = 'MOP'
    MAURITANIAN_OUGUIYA_PRE_2018 = 'Mauritanian Ouguiya (pre-2018)'
    MRO = 'MRO'
    ...
    SSP = 'SSP'
    SAO_TOME_AND_PRINCIPE_DOBRA_PRE_2018 = 'São Tomé and Príncipe Dobra (pre-2018)'
    STD = 'STD'
    SAO_TOME_AND_PRINCIPE_DOBRA = 'São Tomé and Príncipe Dobra'
    STN = 'STN'
    SALVADORAN_COLON = 'Salvadoran Colón'
    SVC = 'SVC'
    ...
    UZS = 'UZS'
    VENEZUELAN_BOLIVAR_FUERTE = 'Venezuelan Bolívar Fuerte'
    VEF = 'VEF'
    ...
    ZAR = 'ZAR'
    ZAMBIAN_KWACHA_PRE_2013 = 'Zambian Kwacha (pre-2013)'
    ZMK = 'ZMK'
    ZAMBIAN_KWACHA = 'Zambian Kwacha'
    ZMW = 'ZMW'

class VariantUniquenessEnum(str):
    DISABLE_ANY_UNIQUENESS_CHECK = 'Disable any uniqueness check for variant attribute sets'
    DISABLED_UNIQUE_CHECKING = 'DISABLED_UNIQUE_CHECKING'
    CHECK_DUPLICATES_PER_SELLER = 'Check for duplicated variant attribute sets within a seller, duplicated variants may still exist globally (pre-product)'
    UNIQUE_PER_SELLER = 'UNIQUE_PER_SELLER'
    CHECK_DUPLICATES_GLOBALLY = 'Check for duplicated variant attribute sets globally (per-product), duplicated variants may not exist in the system'
...
class AvailableShippingStrategyEnum(str):
    AVAILABLE_SHIPPING_METHODS_PER_SELLER_ARE_CALCULATED_USING_ONLY_THE_LINE_TOTALS_FOR_THE_SELLER = (
        'Available shipping methods per seller are calculated using only the line totals for the seller.'
    )
    SELLER_LINES = 'SELLER_LINES'
    AVAILABLE_SHIPPING_METHODS_PER_SELLER_ARE_CALCULATED_USING_EVERY_LINE_TOTAL_NOT_JUST_THE_SELLERS_LINES = (
...
class MarketplaceConfigurationAttributeTemplateStrategy(str):
    ASSIGNED_ATTRIBUTES_MAY_ONLY_COME_FROM_TEMPLATES_PRODUCTTYPE_FOR_PIM_SPECIFIC_ATTRIBUTE_USAGE_OR_CUSTOMFIELDTEMPLATE_FOR_CUSTOM_FIELD_ATTRIBUTE_USAGE_NO_NON_TEMPLATED_ATTRIBUTE_ASSIGNMENT_IS_ALLOWED = (
    ...
    STRICT = 'STRICT'
    ASSIGNED_ATTRIBUTES_MAY_COME_FROM_BOTH_ATTRIBUTE_TEMPLATES_AND_NON_TEMPLATED_ATTRIBUTE_ASSIGNMENTS = (
...
class AttributeTemplateStrategyEnum(str):
    ASSIGNED_ATTRIBUTES_MAY_ONLY_COME_FROM_TEMPLATES_PRODUCTTYPE_FOR_PIM_SPECIFIC_ATTRIBUTE_USAGE_OR_CUSTOMFIELDTEMPLATE_FOR_CUSTOM_FIELD_ATTRIBUTE_USAGE_NO_NON_TEMPLATED_ATTRIBUTE_ASSIGNMENT_IS_ALLOWED = 'Assigned attributes may only come from templates (ProductType for PIM-specific attribute usage or CustomFieldTemplate for custom field attribute usage), no non-templated attribute assignment is allowed'
    STRICT = 'STRICT'
    ASSIGNED_ATTRIBUTES_MAY_COME_FROM_BOTH_ATTRIBUTE_TEMPLATES_AND_NON_TEMPLATED_ATTRIBUTE_ASSIGNMENTS = 'Assigned attributes may come from BOTH attribute templates and non-templated attribute assignments'
    FLEXIBLE = 'FLEXIBLE'
